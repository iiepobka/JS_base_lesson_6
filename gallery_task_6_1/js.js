...
const gallery = {
    ...
    openImage(src) {
        let confirmLoaded = new Image();
        confirmLoaded.src = src;
        confirmLoaded.addEventListener('load', () => {
            this.getScreenContainer().querySelector(`.${this.settings.openedImageClass}`).src = src;
        });
        confirmLoaded.addEventListener('error', () => {
            alert('Большая картинка отсутствует!');
        });
    },
